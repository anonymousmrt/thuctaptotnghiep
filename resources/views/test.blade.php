...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{asset('admin')}}/index.html">ADMINBSB - MATERIAL DESIGN</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="{{asset('admin')}}/pages/typography.html">
                            <i class="material-icons">text_fields</i>
                            <span>Typography</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{asset('admin')}}/pages/helper-classes.html">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="{{asset('admin')}}/pages/widgets/cards/basic.html">Basic</a>
                                    </li>
                                    <li>
                                        <a href="{{asset('admin')}}/pages/widgets/cards/colored.html">Colored</a>
                                    </li>
                                    <li>
                                        <a href="{{asset('admin')}}/pages/widgets/cards/no-header.html">No Header</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="{{asset('admin')}}/pages/widgets/infobox/infobox-1.html">Infobox-1</a>
                                    </li>
                                    <li>
                                        <a href="{{asset('admin')}}/pages/widgets/infobox/infobox-2.html">Infobox-2</a>
                                    </li>
                                    <li>
                                        <a href="{{asset('admin')}}/pages/widgets/infobox/infobox-3.html">Infobox-3</a>
                                    </li>
                                    <li>
                                        <a href="{{asset('admin')}}/pages/widgets/infobox/infobox-4.html">Infobox-4</a>
                                    </li>
                                    <li>
                                        <a href="{{asset('admin')}}/pages/widgets/infobox/infobox-5.html">Infobox-5</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/animations.html">Animations</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/badges.html">Badges</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/breadcrumbs.html">Breadcrumbs</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/colors.html">Colors</a>
                            </li>
                            <li class="active">
                                <a href="{{asset('admin')}}/pages/ui/dialogs.html">Dialogs</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/icons.html">Icons</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/media-object.html">Media Object</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/modals.html">Modals</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/notifications.html">Notifications</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/pagination.html">Pagination</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/sortable-nestable.html">Sortable & Nestable</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/tabs.html">Tabs</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/thumbnails.html">Thumbnails</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/tooltips-popovers.html">Tooltips & Popovers</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/ui/waves.html">Waves</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{asset('admin')}}/pages/forms/basic-form-elements.html">Basic Form Elements</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/forms/advanced-form-elements.html">Advanced Form Elements</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="{{asset('admin')}}/pages/tables/jquery-datatable.html">Jquery Datatables</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/tables/editable-table.html">Editable Tables</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="{{asset('admin')}}/pages/charts/flot.html">Flot</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="{{asset('admin')}}/pages/maps/yandex.html">YandexMap</a>
                            </li>
                            <li>
                                <a href="{{asset('admin')}}/pages/maps/jvectormap.html">jVectorMap</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <div class="body">
                            <div class="row clearfix js-sweetalert">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <p>A basic message</p>
                                    <a class="btn btn-primary waves-effect" data-type="basic">CLICK ME</a>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
    ...
    <script src="{{asset('admin')}}/js/pages/ui/dialogs.js"></script>
